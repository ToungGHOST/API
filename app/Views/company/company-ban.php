							...
							<?php foreach ($data as $item) : ?>
								<tr>
									...
									<a class="btn btn-success chreq"  style="color :#FFF"  data-id="<?= $item['cou_id']; ?>" data-toggle="modal" data-target="#requestInfo"  aria-label="Close" role="button"><i class="fas fa-eye"></i></a>
										...
										href="<?php echo site_url(); ?>/admin/unbancompany/<?= $item['cou_id']; ?>" role="button"><i class="fas fa-sign-in-alt"></i></a>
										<a class="btn btn-danger" value="<?= $item['cou_name_th']; ?>" onclick="confirmDelete(event)"
										 href="<?= base_url(); ?>/admin/deletecompany/<?= $item['cou_id']; ?>" role="button"><i class="fas fa-trash"></i></a>
