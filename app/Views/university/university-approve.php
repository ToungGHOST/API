							...
							<?php foreach ($data as $item) : ?>
								<tr>
									...
									<td>
										...
										<a class="btn btn-warning" value="<?= $item['cou_name_th']; ?>" onclick="confirmApprove(event)"href="<?= base_url(); ?>/admin/approveuniversity/<?= $item['cou_id']; ?>" role="button"><i class="fas fa-check"></i></a>
										<a class="btn btn-danger" value="<?= $item['cou_name_th']; ?>" onclick="confirmDelete(event)" href="<?= base_url(); ?>/admin/banuniversity/<?= $item['cou_id']; ?>" role="button"><i class="fas fa-times"></i></a>
