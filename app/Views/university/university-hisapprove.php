							...
							<?php foreach ($data as $item) : ?>
								<tr>
									...
									<td>
										...
										{
											echo('ระงับ');
										};?>  <a class="btn btn-success chru"  style="color :#FFF"   data-id="<?= $item['cou_id']; ?>" data-toggle="modal" data-target="#requestInfo"  aria-label="Close" role="button"><i class="fas fa-eye"></i></a></p>
