							...
							<?php foreach ($data as $item) : ?>
								<tr>
									...
									<td>
										...
										<a class="btn btn-info" href="<?php echo site_url(); ?>admin/edituniversity/<?= $item['cou_id']; ?>" role="button"><i class="fas fa-edit"></i></a>
                                        <a class="btn btn-warning"  value="<?= $item['cou_name_th']; ?>" onclick="confirmBan(event)" href="<?php echo site_url(); ?>/admin/banuniversity/<?= $item['cou_id']; ?>" role="button"><i class="fas fa-ban"></i></a>
										<a class="btn btn-danger" value="<?= $item['cou_name_th']; ?>" onclick="confirmDelete(event)" href="<?= base_url(); ?>/admin/deleteuniversity/<?= $item['cou_id']; ?>" role="button"><i class="fas fa-trash"></i></a>
