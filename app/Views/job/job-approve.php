		...
		<div class="col-xl-12">
			...
			<div class="card shadow mb-4">
				...
				<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
					<h6 class="m-0 font-weight-bold text-primary">รายชื่อประกาศรออนุมัติ</h6>
						...
						<tbody>
							<?php foreach ($data as $item) : ?>
								<tr>
									...
									<td>
										<a class="btn btn-success chru" style="color :#FFF" data-id="<?= $item['job_id']; ?>" data-toggle="modal" data-target="#requestInfo" aria-label="Close" role="button"><i class="fas fa-eye"></i></a>
										<a class="btn btn-warning" value="<?= $item['job_name']; ?>" onclick="confirmApprove(event)" href="<?= base_url(); ?>/admin/approvejob/<?= $item['job_id']; ?>" role="button"><i class="fas fa-check"></i></a>
										<a class="btn btn-danger" value="<?= $item['job_name']; ?>" onclick="confirmDelete(event)" href="<?= base_url(); ?>/admin/banjob/<?= $item['job_id']; ?>" role="button"><i class="fas fa-times"></i></a>
