		...
		<div class="col-xl-12">
			...
			<div class="card shadow mb-4">
				...
				<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
					<h6 class="m-0 font-weight-bold text-primary">รายชื่อประกาศที่อนุมัติ</h6>
								...
								<tr>
									...
									<td>
										...
										<p><?php $item['status'];
											...
											<a class="btn btn-success chrh" style="color :#FFF" data-id="<?= $item['job_id']; ?>" data-toggle="modal" data-target="#requestInfo" aria-label="Close" role="button"><i class="fas fa-eye"></i></a>
										</p>
