							...
							<?php foreach ($data as $item) : ?>
								<tr>
									...
									<td>
										...
										<a class="btn btn-success" value="<?= $item['firstname']; ?>" onclick="confirmBan(event)" href="<?php echo site_url(); ?>/admin/unbanmember/<?= $item['member_id']; ?>" role="button"><i class="fas fa-sign-in-alt"></i></a>
