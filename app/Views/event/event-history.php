		...
		<div class="col-xl-12">
			...
			<div class="card shadow mb-4">
				...
				<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
					<h6 class="m-0 font-weight-bold text-primary">รายชื่อกิจกรมมที่อนุมัติ</h6>
				...
				<div class="card-body">
					...
					<table class="table">
						<thead>
							<tr>
								<th scope="col">ID</th>
								<th scope="col">ชื่อกิจกรมม</th>
								<th scope="col">ชื่อสถาบัน</th>
								<th scope="col">วันลงทะเบียนกิจกรมม</th>
								...
								<tr>
									...
									<td>
										...
										<p><?php $item['status'];
											...
											<a class="btn btn-success chrh" style="color :#FFF" data-id="<?= $item['event_id']; ?>" data-toggle="modal" data-target="#requestInfo" aria-label="Close" role="button"><i class="fas fa-eye"></i></a>
										</p>
